	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// And redirect to correct home page.
			...
			if (user.getRole().equals("admin")) {
				...
				getServletContext().getRequestDispatcher("/WEB-INF/views/_showfeedback.jsp").forward(request, response);
			} else if(user.getRole().equals("trainee")){
				getServletContext().getRequestDispatcher("/WEB-INF/views/_getfeedback.jsp").include(request, response);
			}else
				getServletContext().getRequestDispatcher("/WEB-INF/views/_showfeedbackfortrainer.jsp").include(request, response);
		}
	}
